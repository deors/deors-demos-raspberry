...
while 1:
    ...
    print('{}'.format('-' * 30))
    print('accel [g]:  x = {:.3f}, y = {:.3f}, z = {:.3f}'.format(ax, ay, az))
    print('gyro [dps]: x = {:.3f}, y = {:.3f}, z = {:.3f}'.format(wx, wy, wz))
    #print('mag [uT]:   x = {:.3f}, y = {:.3f}, z = {:.3f}'.format(mx, my, mz))
    print('temp [C]:   t = {:.3f}'.format(temp))
    print('{}'.format('-' * 30))
    time.sleep(1)
